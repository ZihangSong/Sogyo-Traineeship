...
[![Latest Release](https://git.sogyo.nl/zsong/mancala-java/-/badges/release.svg)](https://git.sogyo.nl/zsong/mancala-java/-/releases)
[![coverage report](https://git.sogyo.nl/zsong/mancala-java/badges/mvc-CI/CD/coverage.svg)](https://git.sogyo.nl/zsong/mancala-java/-/commits/mvc-CI/CD)
[![pipeline status](https://git.sogyo.nl/zsong/mancala-java/badges/mvc-CI/CD/pipeline.svg)](https://git.sogyo.nl/zsong/mancala-java/-/commits/mvc-CI/CD)
